...
🔭 **Currently:** Defended and published **SimForge**, my master's thesis: an open-source, reproducible cross-simulator benchmarking framework for urban traffic simulation, integrating SUMO, MATSim, and DTALite across large-scale geospatial demand pipelines and HPC clusters.
→ Thesis: [OhioLINK ETD](http://rave.ohiolink.edu/etdc/view?acc_num=miami1784152758005036)
...
* **[LumiAI](https://github.com/phanidharakula/Lumi_AI) · [Live site](https://studywithlumi.com):** Production AI tutoring platform serving 60+ active students with document-grounded AI chat, quiz and flashcard generation, SM-2 spaced repetition, and voice mode; currently building Android and iOS companion apps. Built the LLM serverless layer with token-verified requests, server-side API-key isolation, anonymous-call rejection, streaming responses, and prompt caching.
...
* **Master's thesis:** *SimForge: A Reproducible, Cross-Simulator Benchmarking Framework for Urban Traffic Simulation* — Miami University / OhioLINK ETD, 2026
* *Attributable Cross-Simulator Benchmarking for Urban Traffic Simulation: Reproducibility, Consistency, and Regime-Dependent Divergence* — IEEE Transactions on Intelligent Transportation Systems, under review
* *CITYSCAPE: A Digital Twin Framework for Temporospatial Modeling of Work-Commute Dynamics and Roadway Infrastructure Demand* — Frontiers, under review
...
📫 **Reach me:** [LinkedIn](https://linkedin.com/in/phanidharakula) · [Portfolio](https://phanidhar.dev) · [Email](mailto:phanidharakula@gmail.com)
